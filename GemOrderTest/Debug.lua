...
local Debug = {}
GemOrderTest.Debug = Debug

local function Settings()
    GemOrderTestDB.settings = GemOrderTestDB.settings or {}
    return GemOrderTestDB.settings
end
...
function Debug:EnableTaintLog()
    ...
    print("|cff00ccffGemOrderTest|r Taint debug enabled.")
    print("  1. /reload")
...
function Debug:DisableTaintLog()
    ...
    print("|cff00ccffGemOrderTest|r Taint debug disabled.")
end

function Debug:DumpState()
    print("|cff00ccffGemOrderTest|r Taint state snapshot:")
    print("  addon execution secure: " .. (issecure() and "yes" or "NO (tainted)"))
    print("  loggingOut flag: " .. tostring(GemOrderTest._loggingOut))
...
function Debug:SetBisect(flag, enabled)
    ...
    if flag == "reset" then
        ...
        print("|cff00ccffGemOrderTest|r Bisect flags cleared. /reload recommended.")
        return
    end
    ...
    elseif flag == "nouspecial" then
        ...
        print("|cff00ccffGemOrderTest|r Unknown bisect flag. Options:")
    ...
    print("|cff00ccffGemOrderTest|r Bisect " .. flag .. " = " .. tostring(Settings()[key]))
...
function Debug:HandleCommand(msg)
    ...
    print("|cff00ccffGemOrderTest|r Unknown debug command. Try /gor debug help")
end
