...
GemOrderTest_CutGemsCache = nil
GemOrderTest_RareCutGemsCache = nil

GemOrderTest_GemByName = {}
GemOrderTest_GemByItemId = {}
for _, gem in ipairs(GemOrderTest_Gems) do
    GemOrderTest_GemByName[gem.name] = gem
    if gem.itemId then
        GemOrderTest_GemByItemId[gem.itemId] = gem
    end
end

function GemOrderTest_GetCutGems()
    if GemOrderTest_CutGemsCache then
        return GemOrderTest_CutGemsCache
    end
    local list = {}
    for _, gem in ipairs(GemOrderTest_Gems) do
    ...
    GemOrderTest_CutGemsCache = list
    return list
end

function GemOrderTest_GetEpicCutGems()
    return GemOrderTest_GetCutGems()
end

function GemOrderTest_GetRareCutGems()
    if GemOrderTest_RareCutGemsCache then
        return GemOrderTest_RareCutGemsCache
    end
    local list = {}
    for _, gem in ipairs(GemOrderTest_Gems) do
    ...
    GemOrderTest_RareCutGemsCache = list
    return list
end

function GemOrderTest_GetRawGems()
    local list = {}
    for _, gem in ipairs(GemOrderTest_Gems) do
        if gem.raw then
            table.insert(list, gem)
...
function GemOrderTest_GetGemColor(name)
    local gem = GemOrderTest_GemByName[name]
    return gem and gem.color or "Unknown"
end

function GemOrderTest_GetRecipeGems(tier)
    if tier == "rare" then
        return GemOrderTest_GetRareCutGems()
    end
    return GemOrderTest_GetEpicCutGems()
end

function GemOrderTest_IsTrackedRecipeItemId(itemId)
    local gem = GemOrderTest_GemByItemId[itemId]
