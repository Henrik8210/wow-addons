...
function GemOrderTest_HandleItemClick(itemIdOrLink, button)
    if button ~= "LeftButton" and button ~= "LeftButtonUp" then
        return false
    end
    ...
    if chatLink then
        return GemOrderTest_InsertChatItemLink(itemIdOrLink)
    end
...
function GemOrderTest_AttachItemTooltip(frame, getLinkFn)
    ...
    frame:SetScript("OnMouseUp", function(self, button)
        GemOrderTest_HandleItemClick(getLinkFn(self), button)
    end)
end
...
function GemOrderTest_AttachDropdownItemButton(itemId, buttonIndex)
    ...
    button:SetScript("OnMouseUp", function(self, mouseButton)
        ...
        if linkedItemId
            ...
            and self.value > 0
            and self.value == linkedItemId then
            GemOrderTest_HandleItemClick(linkedItemId, mouseButton)
        end
    end)
end
